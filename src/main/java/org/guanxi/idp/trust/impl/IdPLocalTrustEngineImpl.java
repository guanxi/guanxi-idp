...
/**
 * TrustManager implementation that the IdP uses to trust Service Providers via their local metadata
 *
 * @author alistair
 */
public class IdPLocalTrustEngineImpl extends SimpleTrustEngine {
  public IdPLocalTrustEngineImpl() {
    super();
  }
